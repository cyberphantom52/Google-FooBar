...
def find_parent(h, v):
    ...
    left_max = root - pow(2, h - 1)
    if v < left_max:
        return find_parent(h - 1, v)
    elif v == left_max or v - left_max == left_max:
        return root
    else:
        return left_max + find_parent(h - 1, v - left_max)


print(find_parent(4, 12))
